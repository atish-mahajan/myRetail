...
public class ProductControllerTest {
	...
	public void getProductDetailsTest() throws Exception {
		...
		String aR = actualResult.getResponse().getContentAsString();
		//Expected result
		String expectedResult = "{\"id\": \"13860428\",\"name\": \"The Big Lebowski (Blu-ray) (Widescreen)\",\"current_price\": {\"value\": 13.49,\"currency_code\": \"USD\"}}";
	...
	public void updateProductTest() throws Exception {
		...
		Mockito.when(productServiceMock.updateProduct(Mockito.any())).thenReturn(mockedProduct);
